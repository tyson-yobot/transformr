...
function GoogleIcon({ size = 20 }: { size?: number }) {
  return (
    <Text style={{ fontSize: size, fontWeight: '700', color: '#F0F0FC' /* brand-ok */, lineHeight: size + 2 }}>
      G
    </Text>
  );
}
...
const styles = StyleSheet.create({
  ...
  signInBtnText: { color: '#FFFFFF' /* brand-ok */, fontSize: 17, fontWeight: '700', letterSpacing: 1.5 },
  // Divider
