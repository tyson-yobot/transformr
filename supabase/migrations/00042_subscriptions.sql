-- Migration: 00042_subscriptions
-- Creates dedicated subscriptions table, feature gate cache, and trigger
-- to keep profiles.subscription_tier in sync.

-- Enums (create only if they don't already exist)
DO $$ BEGIN
...
-- Sync trigger: when a subscription is created/updated, keep profiles.subscription_tier current.
